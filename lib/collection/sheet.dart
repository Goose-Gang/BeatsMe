...
class SpecialBottomSheet extends StatefulWidget {
  @override
  _SpecialBottomSheetState createState() => _SpecialBottomSheetState();
}
...
final List<Event> events = [
  Event('steve-johnson.jpeg', '', '4.20-30'),
  Event('efe-kurnaz.jpg', '', '4.20-30'),
  Event('rodion-kutsaev.jpeg', '', '4.28-31'),
];
