...
class MyAppState extends State<MyApp>{
  ...
  void initState() {
    ...
    barRowWidth = 30; // total = divider + container?
    dividerWidth = 10;

    _controller = VideoPlayerController.network(
      'https://raw.githubusercontent.com/cindywang328/yikes/master/audio.mp3',
    );
      ...
      setState(() { 
        isAutoScrolling = !isAutoScrolling;
            ...
            if (_controller.value.isPlaying) {
              ...
              _controller.seekTo(Duration(seconds: (scrollController.position.pixels~/barRowWidth)));
